...
const conseils = [
  ...
  { texte: "Lève-toi et marche 5 minutes toutes les heures — la sédentarité prolongée est un facteur de risque indépendant même si tu fais du sport.", pilier: "Mouvement", couleur: "#FAECE7", textColor: "#712B13" },
  { texte: "Prends les escaliers aujourd'hui — chaque occasion de bouger compte, même les plus petites.", pilier: "Mouvement", couleur: "#FAECE7", textColor: "#712B13" },
  { texte: "Fais 10 minutes d'étirements ce soir — tes muscles et articulations te remercieront demain matin.", pilier: "Mouvement", couleur: "#FAECE7", textColor: "#712B13" },
  { texte: "Une marche de 30 minutes après le dîner améliore la digestion et régule la glycémie postprandiale.", pilier: "Mouvement", couleur: "#FAECE7", textColor: "#712B13" },
  { texte: "Ajoute 2 séances de renforcement musculaire par semaine — après 30 ans on perd 1% de masse musculaire par an sans exercice.", pilier: "Mouvement", couleur: "#FAECE7", textColor: "#712B13" },
  { texte: "Vérifie ta posture maintenant — épaules relâchées, écran à hauteur des yeux, pieds à plat au sol.", pilier: "Mouvement", couleur: "#FAECE7", textColor: "#712B13" },
  { texte: "Le meilleur sport est celui que tu pratiques régulièrement — choisis une activité qui te plaît plutôt que celle qui brûle le plus de calories.", pilier: "Mouvement", couleur: "#FAECE7", textColor: "#712B13" },
  { texte: "Après une séance de sport, mange des protéines dans l'heure — c'est la fenêtre optimale pour la récupération musculaire.", pilier: "Mouvement", couleur: "#FAECE7", textColor: "#712B13" },
  { texte: "Boire un grand verre d'eau avant chaque repas aide à mieux contrôler les portions et favorise une bonne digestion — une habitude simple et très efficace.", pilier: "Nutrition", couleur: "#EAF3DE", textColor: "#27500A" },
];
