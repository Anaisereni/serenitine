...
C’est de ce constat qu’est née, en 2026, l’envie de créer cette application : un outil simple et accessible, pensé pour accompagner chacun vers de meilleures habitudes de vie. Pour aller plus loin et pour avoir des conseils personnalisés, je propose des consultations en visio autour du bien-être et de l’hygiène de vie via Doctolib (prendre rdv 'en vidéo'). Mes conseils sur l'utilisation de l'app: le but n'est pas de compléter toutes les routines tous les jours et toutes les semaines dès le départ, le but est d'avancer à son rythme et de prendre progressivement de nouvelles habitudes. Enfin, ne surtout pas hésiter à parcourir l'onglet Ressources qui regorge d'informations utiles et d'outils pratiques.</p>
      </div>
    </div>
  );
}
