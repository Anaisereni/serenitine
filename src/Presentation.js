...
C’est de ce constat qu’est née, en 2026, l’envie de créer cette application : un outil simple et accessible, pensé pour accompagner chacun vers de meilleures habitudes de vie. Pour aller plus loin, je propose des consultations personnalisées en visio autour du bien-être et de l’hygiène de vie via Doctolib (prendre rdv 'en vidéo').</p>
      </div>
    </div>
  );
}
